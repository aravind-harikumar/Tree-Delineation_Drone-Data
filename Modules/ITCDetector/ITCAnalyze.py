...
class AnalyzeUtils:
    ...
    def __init__(self, FileDataInfo):
        ...
        self.Li6400Data = FileDataInfo['Li6400File']
        self.PigmentsData = FileDataInfo['Pigments']
        self.SCAData = FileDataInfo['SCA']
        self.WaterPotentialData = FileDataInfo['Water_potential']
