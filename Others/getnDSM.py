...
def GenerateNDSM():
    ...
    # Parameters
    ParamsDict = {
        'base_path'               : '/mnt/4TBHDD/StCasimir-Multispectral-Analysis/1_InputForAnalayis/NEW20170626',
        'dem_file_name'           : 'DEM.tif',
        'dsm_file_name'           : 'DSM.tif',
        'ndsm_file_name'          : 'nDSM1.tif',
        'ndsm_min_ht'             : 0, # lower limit to remove noise
        'ndsm_max_ht'             : 20, # upper limit to remove noise
        'Reproject'               : True,
        'HistogramEqualizeOutput' : False,
...
class NDSM_Generator_Class():
    ...
    def ReprojectImage(self):
        ...
        RasterOperators.ReprojectImage(in_image, out_image, force_reprojection, self.CRS)
    ...
    def CropImageByShpMask(self):
        ...
        in_shp_file = os.path.join(self.base_path, self.StudyAreaShp)
